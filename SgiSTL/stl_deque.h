...
public:                         // Constructor, destructor.
  ...
  deque(size_type __n, const value_type& __vvalue,
        const allocator_type& __a = allocator_type()) : _Base(__a, __n)
    { _M_fill_initialize(__vvalue); }
...
protected:                        // Internal construction/destruction
  ...
  void _M_fill_initialize(const value_type& __vvalue);
...
template <class _Tp, class _Alloc>
void deque<_Tp,_Alloc>::_M_fill_initialize(const value_type& __vvalue) {
  _Map_pointer __cur;
  __STL_TRY {
    for (__cur = _M_start._M_node; __cur < _M_finish._M_node; ++__cur)
      uninitialized_fill(*__cur, *__cur + _S_buffer_size(), __vvalue);
    uninitialized_fill(_M_finish._M_first, _M_finish._M_cur, __vvalue);
  }
