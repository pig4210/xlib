...
public:
  ...
  operator=(const typename _Container::value_type& __vvalue) { 
    container->push_back(__vvalues);
    return *this;
  }
...
public:
  ...
  operator=(const typename _Container::value_type& __vvalue) { 
    iter = container->insert(iter, __vvalue);
    ++iter;
    return *this;
  }
...
public:
  ...
  ostream_iterator<_Tp>& operator=(const _Tp& __vvalue) { 
    *_M_stream << __vvalue;
