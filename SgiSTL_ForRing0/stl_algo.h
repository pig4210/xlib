...
void count(_InputIter __first, _InputIter __last, const _Tp& __vvalue,
           _Size& __n) {
  __STL_REQUIRES(_InputIter, _InputIterator);
...
count(_InputIter __first, _InputIter __last, const _Tp& __vvalue) {
  __STL_REQUIRES(_InputIter, _InputIterator);
  __STL_REQUIRES(typename iterator_traits<_InputIter>::value_type,
                 _EqualityComparable);
  __STL_REQUIRES(_Tp, _EqualityComparable);
...
_OutputIter remove_copy(_InputIter __first, _InputIter __last,
                        _OutputIter __result, const _Tp& __vvalue) {
  __STL_REQUIRES(_InputIter, _InputIterator);
  __STL_REQUIRES(_OutputIter, _OutputIterator);
  __STL_REQUIRES_BINARY_OP(_OP_EQUAL, bool,
       typename iterator_traits<_InputIter>::value_type, _Tp);
...
_ForwardIter remove(_ForwardIter __first, _ForwardIter __last,
  ...
  __STL_REQUIRES_BINARY_OP(_OP_EQUAL, bool,
       typename iterator_traits<_ForwardIter>::value_type, _Tp);
  __STL_CONVERTIBLE(_Tp, typename iterator_traits<_ForwardIter>::value_type);
  __first = find(__first, __last, __vvalue);
  _ForwardIter __i = __first;
  return __first == __last ? __first 
                           : remove_copy(++__i, __last, __first, __vvalue);
}
...
_OutputIter __unique_copy(_InputIter __first, _InputIter __last,
  ...
  *__result = __vvalue;
  while (++__first != __last)
    if (!__binary_pred(__vvalue, *__first)) {
      __vvalue = *__first;
      *++__result = __vvalue;
    }
  return ++__result;
