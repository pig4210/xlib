/**
  \file  xlib_struct.h
  \brief xlib_struct.h 定义了一些未文档化的结构，供 Ring0 、 Ring3 通用 。
...
#ifdef _WIN64
  TUINT ZReserved:32;  ///< x64 下高 32 位保留 。
#endif
  };
...
typedef struct _SYSTEM_MODULE_INFORMATION
  {
  TUINT         NumberOfModules:32; ///< x64 下真实有效值只有 32 位 。
...
typedef struct _SYSTEM_HANDLE_INFORMATION 
  {
  TUINT         NumberOfHandles:32; ///< x64 下真实有效值只有 32 位 。
